...
contract Agent {
    ...
    function add_agent(string memory _name, uint _age, uint _phoneno, string memory _gender, uint _designation, string memory _hash) public returns(string memory){
